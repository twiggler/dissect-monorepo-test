...
```bash
just test dissect.cstruct
```

To build source and wheel distributions:

```bash
uv build --package dissect.cstruct --out-dir dist/dissect.cstruct
```

The build artifacts can be found in the `dist/dissect.cstruct/` directory.
