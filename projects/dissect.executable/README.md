...
```bash
just test dissect.executable
```

To build source and wheel distributions:

```bash
uv build --package dissect.executable --out-dir dist/dissect.executable
```

The build artifacts can be found in the `dist/dissect.executable/` directory.
