...
```bash
just test dissect.hypervisor
```

To build source and wheel distributions:

```bash
uv build --package dissect.hypervisor --out-dir dist/dissect.hypervisor
```

The build artifacts can be found in the `dist/dissect.hypervisor/` directory.
