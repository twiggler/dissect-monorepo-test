...
```bash
just test dissect.evidence
```

To build source and wheel distributions:

```bash
uv build --package dissect.evidence --out-dir dist/dissect.evidence
```

The build artifacts can be found in the `dist/dissect.evidence/` directory.
