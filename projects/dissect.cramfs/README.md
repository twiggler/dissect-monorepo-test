...
```bash
just test dissect.cramfs
```

To build source and wheel distributions:

```bash
uv build --package dissect.cramfs --out-dir dist/dissect.cramfs
```

The build artifacts can be found in the `dist/dissect.cramfs/` directory.
