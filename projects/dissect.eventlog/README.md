...
```bash
just test dissect.eventlog
```

To build source and wheel distributions:

```bash
uv build --package dissect.eventlog --out-dir dist/dissect.eventlog
```

The build artifacts can be found in the `dist/dissect.eventlog/` directory.
