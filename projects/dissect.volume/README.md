...
```bash
just test dissect.volume
```

To build source and wheel distributions:

```bash
uv build --package dissect.volume --out-dir dist/dissect.volume
```

The build artifacts can be found in the `dist/dissect.volume/` directory.
