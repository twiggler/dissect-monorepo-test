...
```bash
just test dissect.shellitem
```

To build source and wheel distributions:

```bash
uv build --package dissect.shellitem --out-dir dist/dissect.shellitem
```

The build artifacts can be found in the `dist/dissect.shellitem/` directory.
